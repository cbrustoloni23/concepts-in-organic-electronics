...
<!-- end #menu --><div id="page">
        <div id="content-full">
	<p>Aimed at undergraduates, graduate students, and practicing engineers, this textbook covers the essential principles of organic electronics from its fundamental concepts to describing archetype devices that exploit the unique properties of the immense materials family of organic semiconductors in use today.</p>
	<p>Lecture notes designed for a one semester-long organic electronics courses are available to those who have registered their name and information. Registration is free and is only for the purpose of record keeping. You may log in or register below.</p>
        <ul><br/>
	<img src="cover.png" width="750" align="center">
	<p>Cover Image: "Elmer Imes: Quantized Rotation," created by Jens Zorn and David Crosby. Illustrated by Haonan Zhao.</p>
        </div>
		 
 
         <div style="clear: both;">&nbsp;</div>
        <div class="phppot-container">
        <?php require_once __DIR__ . '/login-form.php';
        ?>
<div style="clear: both;">&nbsp;</div>
<div style="clear: both;">&nbsp;</div>
</br>
<!-- end #page -->
        <div id="footer">
               <p>&nbsp;</p>
        <p align="center"><a class="news-footer" href="links.html"> Links |</a><a class="news-footer" href="logout.php"> Logout</a><font size="5"></p>
